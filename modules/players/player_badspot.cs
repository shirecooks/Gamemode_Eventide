datablock PlayerData(PlayerBadspot : PlayerRenowned) 
{
	uiName = "Badspot Player";
	...
	killerChaseLvl1Music = "musicData_Eventide_BadspotNear";
	killerChaseLvl2Music = "musicData_Eventide_BadspotChase";
...
datablock ShapeBaseImageData(BadspotImage) 
{
	shapeFile = "Add-Ons/Gamemode_Eventide/modules/players/models/Badspot.dts";
	mountPoint = $HeadSlot;
	offset = "0 0 0";
	eyeOffset = "0 0 -1000";
...
function PlayerBadspot::onTrigger(%this, %obj, %trig, %press) 
{		
...
function PlayerBadspot::onPeggFootstep(%this,%obj)
{
	serverplay3d("shadow_walking" @ getRandom(1,4) @ "_sound", %obj.getHackPosition());
}

function PlayerBadspot::onNewDatablock(%this,%obj)
{
		//Face system functionality.
	%obj.createFaceConfig($Eventide_FacePacks["badspot"]);
	
	Parent::onNewDatablock(%this,%obj);
	%obj.mountImage(%this.killerweapon, $LeftHandSlot);
	%obj.mountImage("BadspotImage", 2);
	%obj.setScale("1 1 1");
...
function PlayerBadspot::onRemove(%this, %obj)
{
...
function PlayerBadspot::EventideAppearance(%this,%obj,%client)
{
	%obj.hideNode("ALL");	
	...
	%primaryColor = "0.15 0.15 0.15 1";
	%secondaryColor = "0.05 0.05 0.05 1";
	%accentColor = "0.9 0.9 0 1";
	%skinColor = "0.83 0.73 0.66 1";

	%obj.setDecalName("none");
	%obj.setNodeColor("rarm",%primaryColor);
	%obj.setNodeColor("larm",%primaryColor);
	%obj.setNodeColor("chest",%primaryColor);
	%obj.setNodeColor("pants",%primaryColor);
	%obj.setNodeColor("rshoe",%primaryColor);
	%obj.setNodeColor("lshoe",%primaryColor);
	%obj.setNodeColor("rhand",%secondaryColor);
	%obj.setNodeColor("lhand",%secondaryColor);
	%obj.setNodeColor("armor",%secondaryColor);
	%obj.setNodeColor("shoulderPads",%accentColor);
...
function PlayerBadspot::onKillerChaseStart(%this, %obj, %chasing)
{
...
function PlayerBadspot::onKillerChase(%this, %obj, %chasing)
{
	if(!%chasing)
    {
...
function PlayerBadspot::onKillerChaseEnd(%this, %obj)
{
...
function PlayerBadspot::onExitStun(%this, %obj)
{
...
function PlayerBadspot::onAllRitualsPlaced(%this, %obj)
{
...
function PlayerBadspot::onRoundEnd(%this, %obj, %won)
{
...
function PlayerBadspot::onIncapacitateVictim(%this, %obj, %victim, %killed)
{
...
function Player::BadspotGaze(%obj)
{
...
function PlayerBadspot::onDamage(%this, %obj, %delta)
{
	Parent::onDamage(%this, %obj, %delta);
	if(%obj.getState() !$= "Dead")
	{
		%obj.playaudio(0,"" @ getRandom(1, 1) @ "_sound");
	}
}